...
router.get("/merchant/:merchantId", async (req, res) => {
  ...
  const deals = await Deal.find({ merchant: merchantId }).populate("category").populate("thingstoremember").populate("howtouse").populate("cancellationpolicy").exec();
  res.json(deals);
});
